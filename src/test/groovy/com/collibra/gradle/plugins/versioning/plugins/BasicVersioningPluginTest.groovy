...
import com.collibra.gradle.plugins.versioning.VersionNumber
...
class BasicVersioningPluginTest {
    @Test
...
""" as String
    ...
    void 'Git release branch with custom versionNumber computing'() {
        try (GitRepo repo = new GitRepo()) {
            ...
            new BasicVersioningPlugin().apply(project)
            project.versioning {
                parseVersionNumber = { SCMInfo gitInfo, String versionReleaseType, String versionBranchId,
